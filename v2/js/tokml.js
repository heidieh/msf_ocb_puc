...
function iconUrl(_) {
    ...
    return (_.act_type=='intervention') ? 'images/intervention.png' : 
        (_.act_type=='evaluation') ? 'images/evaluation.png' : 
        (_.act_type=='alerte_alarme') ? 'images/alerte_alarme.png' :
        (_.act_type=='alerte_focus') ? 'images/alerte_focus.png' : 
        (_.act_type=='alerte_suivi_actif') ? 'images/alerte_suivi_actif.png' : 
        (_.act_type=='alerte_ferme') ? 'images/alerte_ferme.png' :  
