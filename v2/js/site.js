...
function updateClusters() {
	//console.log("in updateClusters()");
	//currentActData = getCurrentActData();
    //console.log("currentActData: ", currentActData);
    updateActivityClusters();
}



function generateMap(id, data, responseText_zs, responseText_prov, responseText_provbound, responseText_riv, responseText_lakes, responseText_acts) { 		
...
//var geojsonClusterPath = 'data/traffic_accidents.geojson';
var currentActData;
var currentMapData;
...
window.onload = function () {
    ...
    var url_act = 'data/trafficaccidents.geojson' 
    ...
    function handler(){
        ...
        //if ((req.readyState === XMLHttpRequest.DONE) && (req2.readyState === XMLHttpRequest.DONE) && (req3.readyState === XMLHttpRequest.DONE) && (req4.readyState === XMLHttpRequest.DONE) && (req5.readyState === XMLHttpRequest.DONE) && (req6.readyState === XMLHttpRequest.DONE))  {
        	//console.log(req2.responseText)
        	map = generateMap('#map', [], req.responseText, req2.responseText, req3.responseText, req4.responseText, req5.responseText);
			//map = generateMap('#map', [], req.responseText, req2.responseText, req3.responseText, req4.responseText, req5.responseText, req6.responseText);
			createTimeRangeButtons();
			createTimeSeriesCharts('#timeseries', '#timeseriesbrush');
			updateMapInfo('', '', '', '');
			updateMapLegend(g.currentvars.currentMinVal, g.currentvars.currentMaxVal);
